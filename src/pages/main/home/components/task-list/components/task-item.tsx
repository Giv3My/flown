...
export const TaskItem: FC<TaskItemProps> = ({ task }) => {
  return (
    <div
      key={task.id}
      className="p-4 basis-[33%] min-h-[200px] flex flex-col gap-y-2 rounded-md text-text-base bg-surface-2"
    >
      ...
      <Typography className="line-clamp-2">{task.description}</Typography>
